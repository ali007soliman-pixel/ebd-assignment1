...
Hero: Ali Osama the Rogue
Student ID: 16003128
GitHub account: ali007soliman-pixel

A **Sphinx Wraith** bars the way near **Alexandria**. It only falls to
the exact blow.
...
4. Your warcry — copy the line below exactly, including punctuation:
   ...
   "By Alexandria, the Sphinx Wraith flees!"
